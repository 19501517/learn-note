...
import listenerbasedspring.constant.ListenerConstants;
import listenerbasedspring.definition.ListenerDefinition;
import listenerbasedspring.exception.ListenerDispatcherInitException;
import listenerbasedspring.filters.ListernerMethodFilter;
...
/**
 * 监听器解析，目前只有打了{@link listenerbasedspring.annotation.Listener}注解，
...
public class ListenerDispatcherParser implements BeanDefinitionParser {
    ...
    /**
     * 类级过滤，默认只有{@link listenerbasedspring.annotation.Listener}注解过滤
     */
